 ...
 */
package poli.computadores.services;
...
public class RectrineGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ProgramElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "poli.computadores.Rectrine.Program");
	...
	public class EntidadeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "poli.computadores.Rectrine.Entidade");
	...
	public class CampoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "poli.computadores.Rectrine.Campo");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LigacaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "poli.computadores.Rectrine.Ligacao");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public RectrineGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tTIPO = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "poli.computadores.Rectrine.TIPO");
		this.tMULT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "poli.computadores.Rectrine.MULT");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("poli.computadores.Rectrine".equals(grammar.getName())) {
				return grammar;
			}

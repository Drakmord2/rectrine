...
public class InternalRectrineLexer extends Lexer {
    ...
    public final void mRULE_TIPO() throws RecognitionException {
        try {
            int _type = RULE_TIPO;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:333:11: ( ( 'integer' | 'string' | 'boolean' | 'datetime' ) )
            // InternalRectrine.g:333:13: ( 'integer' | 'string' | 'boolean' | 'datetime' )
            {
            // InternalRectrine.g:333:13: ( 'integer' | 'string' | 'boolean' | 'datetime' )
            int alt1=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                case 1 :
                    // InternalRectrine.g:333:14: 'integer'
                    {
                    match("integer"); 
                    ...
                    break;
                case 2 :
                    // InternalRectrine.g:333:24: 'string'
                    {
                    match("string"); 
                    ...
                    break;
                case 3 :
                    // InternalRectrine.g:333:33: 'boolean'
                    {
                    match("boolean"); 
                    ...
                    break;
                case 4 :
                    // InternalRectrine.g:333:43: 'datetime'
                    {
                    match("datetime"); 
    ...
    public final void mRULE_MULT() throws RecognitionException {
        try {
            int _type = RULE_MULT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:335:11: ( ( 'one' | 'many' ) )
            // InternalRectrine.g:335:13: ( 'one' | 'many' )
            {
            // InternalRectrine.g:335:13: ( 'one' | 'many' )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalRectrine.g:335:20: 'many'
                    {
                    match("many"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:337:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRectrine.g:337:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRectrine.g:337:11: ( '^' )?
            int alt3=2;
            ...
            // InternalRectrine.g:337:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:339:10: ( ( '0' .. '9' )+ )
            // InternalRectrine.g:339:12: ( '0' .. '9' )+
            {
            // InternalRectrine.g:339:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:341:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRectrine.g:341:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRectrine.g:341:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalRectrine.g:341:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRectrine.g:341:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalRectrine.g:341:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRectrine.g:341:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:343:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRectrine.g:343:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRectrine.g:343:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:345:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRectrine.g:345:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRectrine.g:345:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:347:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRectrine.g:347:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRectrine.g:347:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRectrine.g:349:16: ( . )
            // InternalRectrine.g:349:18: .
            {
            matchAny(); 
